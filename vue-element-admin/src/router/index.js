...
export const constantRoutes = [
  ...
  // 課程管理
  {
    path: '/course',
    component: Layout,
    redirect: '/coruse/index',
    name: 'User',
    meta: { title: '課程管理', icon: 'user' },
    children: [
      {
        path: 'index',
        name: 'course',
        component: () => import('@/views/course/index'),
        meta: { title: '課程列表', icon: 'list' }
      }
      // {
      //   path: 'tree',
      //   name: 'Tree',
      //   component: () => import('@/views/tree/index'),
      //   meta: { title: '你好小籠包', icon: 'tree' }
      // }
    ]
  },
  { // 學生管理
    ...
    name: 'Video',
    meta: { title: '學生管理', icon: 'el-icon-s-help' },
    children: [
      {
        path: 'index',
        name: 'video',
        component: () => import('@/views/video/index'),
        meta: { title: '學生列表', icon: 'list' }
      }
      // {
      //   path: 'tree',
      //   name: 'Tree',
  ...
  { // 教材管理
    ...
    meta: { title: '教材管理', icon: 'el-icon-s-help' },
    children: [
      {
        path: 'index',
        name: 'category',
        component: () => import('@/views/category/index'),
        meta: { title: '教材列表', icon: 'form' }
      }
    ]
  },
  {
